...
// Dummy appgyver object to detect calls made to appgyver object.
if(!window.AppGyver) {
    window.AppGyver = {
        contexts : [],
        back_context : null,
        ...
        _log : function(id, args) {
            if(console) {
                ...
                console.log('DEBUB: Appgyver method "' + id + '" called with args (' + $.makeArray(args).join(',') + ')');
            }
        },

        reloadContext : function() {
            this._log('reloadContext', arguments);
        },

        switchContext : function(context) {
            this.contexts.push(context);

            this._log('switchContext', arguments);
        },
        ...
        hideContent : function() {
            this._log('hideContent', arguments);
        },

        requireListingRefresh : function() {
            this._log('requireListingRefresh', arguments);
        }
    }
}
